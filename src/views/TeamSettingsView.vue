        ...
        <div class="w-full max-w-md p-5 mx-auto my-5 transition-all duration-500 ease-in-out transform bg-white rounded-md shadow-md hover:scale-105">
            ...
            <div>
                ...
                <div v-for="(member, i) in members" :key="i" class="relative mb-4">
                    ...
                    <button class="absolute top-0 right-0 p-1 mt-2 mr-2 text-white bg-red-500 rounded-full hover:bg-red-700 focus:outline-none focus:shadow-outline" @click="deleteMembers(members, i)">
